...
# ============================================================================ #
#  ЗАМОРОЖЕНО (см. ADR.md, ADR-001/ADR-002; REFACTORING_PLAN.md, Этап B.3)      #
#                                                                              #
#  Этот файл — устаревший дубликат пакета bot/ (AUDIT.md §2.2, §5.1) и не     #
#  является тем, что реально запускается в проде — см. bot/__main__.py и     #
#  selfbot/scripts/start_bot.sh (`python -m bot`).                           #
#                                                                              #
#  С 2026-07-30 функциональные правки сюда больше не вносятся. Файл будет     #
#  удалён целиком в Фазе H после завершения Фаз A–G (см.                     #
#  REFACTOR_PROGRESS.md) и явного подтверждения пользователя. Любые новые    #
#  изменения поведения бота вносите только в bot/.                           #
# ============================================================================ #
